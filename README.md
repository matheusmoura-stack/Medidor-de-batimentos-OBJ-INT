...
- **Indicadores visuais:**
  - 🔴 LED Vermelho → batimentos elevados  
  - 🟢 LED Verde → batimentos normais  
  - 🟡 LED Amarelo → batimentos abaixo do ideal  
...
2. **Classificação da frequência cardíaca:**
   ...
   - BPM entre 50 e 120 → Ritmo normal 🟢  
   - BPM > 120 → Ritmo elevado 🔴  
3. **Alertas automáticos:**
   - Acionamento do LED correspondente  
...
- ✅ **LED:** acende corretamente conforme a faixa de BPM  
